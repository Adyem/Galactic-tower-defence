...
inline constexpr UiRect loadoutStartButton{460, 590, 360, 38};
inline constexpr UiRect loadoutDailyButton{850, 590, 240, 38};
...
inline UiRect workshopModuleButton(int index) { return {160 + index * 220, 410, 190, 52}; }
inline UiRect workshopSupportButton(int index) { return {160 + index * 220, 470, 190, 28}; }
...
inline UiRect loadoutSupportCard(int index) { return {160 + index * 220, 494, 190, 20}; }
inline UiRect loadoutUltimateCard(int index) { return {160 + index * 220, 520, 190, 48}; }
inline UiRect loadoutSkillButton(int index) { return {190 + index * 180, 674, 140, 38}; }
inline UiRect loadoutSkinCard(int index) { return {900 + index * 68, 150, 58, 28}; }
